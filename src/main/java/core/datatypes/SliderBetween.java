...
public class SliderBetween extends KomElement {

	KomElement sliderLower;
	KomElement sliderUpper;

	public SliderBetween(By byID, By byIDLower, By byIDUpper) {
		super(byID);
		sliderLower = new KomElement(byIDLower);
		sliderUpper = new KomElement(byIDUpper);
	}
